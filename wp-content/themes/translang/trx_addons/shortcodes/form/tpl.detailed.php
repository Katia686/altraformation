...
<div
	...
	<div class="<?php echo esc_attr(trx_addons_get_columns_wrap_class()); ?> columns_padding_bottom"><?php
		...
		?><div class="<?php echo esc_attr(trx_addons_get_column_class(5, 12)); ?>">
			<div class="sc_form_info">
				<h4 class="widget_title">Stay in Touch</h4>
				<?php
				if (!empty($args['address'])) {
					...
					<div class="sc_form_info_item sc_form_info_item_address">
						...
						<span class="sc_form_info_area_place">
							<span class="sc_form_info_title"><?php esc_html_e('Address:', 'translang'); ?></span>
				...
				if (!empty($args['phone'])) {
					...
					<div class="sc_form_info_item sc_form_info_item_phone">
						<!-- <span class="sc_form_info_icon"></span> -->
						<span class="sc_form_info_area_place">
							<span class="sc_form_info_title"><?php esc_html_e('Phone:', 'translang'); ?></span>
							<span class="sc_form_info_data"><?php
				...
				if (!empty($args['email'])) {
					...
					<div class="sc_form_info_item sc_form_info_item_email">
						<!-- <span class="sc_form_info_icon"></span> -->
						<span class="sc_form_info_area_place">
							<span class="sc_form_info_title"><?php esc_html_e('E-mail:', 'translang'); ?></span>
						<span class="sc_form_info_data"><?php
				...
				// Social icons
					?><div class="contacts_socials socials_wrap"><?php echo the_widget( 'trx_addons_widget_socials'); ?></div>
			</div>

		</div><?php
		// Contact data. Attention! Column's tags can't start from new line
		?><div class="<?php echo esc_attr(trx_addons_get_column_class(7, 12)); ?>">
			...
			<form class="sc_form_form <?php if ($form_style != 'default') echo 'sc_input_hover_'.esc_attr($form_style); ?>" method="post" action="<?php echo admin_url('admin-ajax.php'); ?>">
				...
				trx_addons_get_template_part('shortcodes/form/tpl.form-field.php',
												...
												array_merge($args, array(
																...
																'field_title' => __('Name', 'translang'),
																'field_placeholder' => __('Name', 'translang')
																))
											);
				?>
				...
				trx_addons_get_template_part('shortcodes/form/tpl.form-field.php',
												...
												array_merge($args, array(
																...
																'field_title' => __('E-mail', 'translang'),
																'field_placeholder' => __('E-mail', 'translang')
																))
											);
				?></div></div><?php
				trx_addons_get_template_part('shortcodes/form/tpl.form-field.php',
												...
												array_merge($args, array(
																...
																'field_req'   => true,
																'field_icon'  => 'trx_addons_icon-mail',
																'field_title' => __('Subject', 'translang'),
																'field_placeholder' => __('Subject', 'translang')
																))
											);
				...
				trx_addons_get_template_part('shortcodes/form/tpl.form-field.php',
												...
												array_merge($args, array(
																...
																'field_title' => __('Message', 'translang'),
																'field_placeholder' => __('Enter your message', 'translang')
																))
											);
				?>
                ...
                if (!empty($privacy)) {
                    ...
                    ?><input type="checkbox" id="i_agree_privacy_policy_sc_form_4" name="i_agree_privacy_policy" class="sc_form_privacy_checkbox" value="1">
                    <label for="i_agree_privacy_policy_sc_form_4"><?php trx_addons_show_layout($privacy); ?></label>
                    </div><?php
                }
                ?><div class="sc_form_field sc_form_field_button sc_form_field_submit"><?php
                    ...
                    ?>><?php
                        if (!empty($args['button_caption']))
                            ...
                            esc_html_e('Send Message', 'translang');
                        ?></button>
                </div>
