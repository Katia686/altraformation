...
if ($args['slider']) {
	...
	?><div class="<?php echo esc_attr(trx_addons_get_column_class(1, 3)); ?>"><?php
}
?>
<div class="sc_team_item">
	...
	<div class="sc_team_item_info">
		...
		?>
		<div class="sc_team_item_button"><a href="<?php echo esc_url($link); ?>" class="sc_button sc_button_simple"><?php esc_html_e('Learn more', 'translang'); ?></a></div>
	</div>
</div>
<?php
